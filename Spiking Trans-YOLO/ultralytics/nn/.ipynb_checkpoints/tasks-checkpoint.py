...
from ultralytics.nn.modules import (AIFI, C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x,
                                    ...
                                    SpikeSPPF,SpikeConv,SpikeDetect,MS_AllConvBlock,SpikeRTDETRDecoder,MS_AIFI,MS_TransformerEncoderLayer,SpikeClassify)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (SpikeConv,SpikeSPPF,SpikeClassify,
        ...
        elif m in (RTDETRDecoder, SpikeRTDETRDecoder):  # special case, channels arg must be passed in index 1
            #print(m)
